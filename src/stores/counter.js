...
export const useCounterStore = defineStore('counter', {
  state: () => {
    return {
      ...
      Number_Table: 1, Show_Table_Information: false, Show_Table_Oder: false, Update_Code_Oder: 1, Menu: false, HD: false,
      Data_Food_King: {
        Ban_so: 1,
        Ma_HD: 555554,
        Ghi_chu: '',
        ...
        Haisan: [{ Ten: 'Tôm sú', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Cá hồi', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Cá thu', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }],
        Thuysan: [{ Ten: 'Cá chép', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Ốc bươu', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Ngao', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }],
        Cacloaithit: [{ Ten: 'Thịt bò mỹ', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Thịt lợn', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Thịt cừu', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }],
        Khac: [{ Ten: 'Trứng hấp', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Canh rong biển', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Bánh mì', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }],
        Douong: [{ Ten: 'Cocacola', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Rượu vang đỏ', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }, { Ten: 'Sữa dê', Thongtin: 'Tươi ngon\r\nSize M', Gia: 1000, Anh: 'https://i.ytimg.com/vi/cZ1SBk313C4/maxresdefault.jpg', SL: 0, DG: 0, CH: 'Còn hàng', CHT: 'Chưa hoàn thành', Show_CH: 0, Show_CHT: 0 }],
      ...
      newTable: '', ALL_Table: '', orderId: '', dist_new: '', Update_Dist_New: '',
  ...
  actions: {
    ...
    async Login_Account() {
      this.Data_login = await axios({ method: 'post', url: this.URLServer + '/account/login', data: { "userCode": this.Username, "password": this.Pasword } });
    ...
    async Set_Table_New() {
      this.Table_New = await axios({ method: 'post', url: this.URLServer + '/order/new', data: { "newTable": newTable } });
      this.Table_New = await this.Table_New.data;
    },
    async Get_ALL_Table() {
      this.ALL_Table = await axios({ method: 'get', url: this.URLServer + '/table/get-all' });
    ...
    async Oder_New() {
      this.Oder_New = await axios({ method: 'post', url: this.URLServer + '/order/new', data: { "userCode": this.Table_Code_Oder.Coder_Oder, "tableId": this.Table_Code_Oder.Number_Table_Oder } });
      this.Oder_New = await this.Oder_New.data;
    },
    async Delete_Oder() {
      this.delete_oder = await axios({ method: 'delete', url: this.URLServer + '/order/remove-order', params: { "orderId": this.orderId } });
    ...
    async Dist_New() {
      this.dist_new = await axios({ method: 'post', url: this.URLServer + '/dish/new-dish', data: { 'Tong_hop_mon_an': this.Data_Food_King } });
    ...
    F_Table_Code_Oder() {
      ...
      for (let i1 = 0; i1 < this.Data_Food_King.Cacloaithit.length; i1++) {
        if (this.Data_Food_King.Cacloaithit[i1].SL > 0) {
          this.Table_Code_Oder.List_Food.push(this.Data_Food_King.Cacloaithit[i1]);
        }
      };
      ...
      for (let i1 = 0; i1 < this.Data_Food_King.Trangmieng.length; i1++) {
        if (this.Data_Food_King.Trangmieng[i1].SL > 0) {
          this.Table_Code_Oder.List_Food.push(this.Data_Food_King.Trangmieng[i1]);
        }
      };
    ...
    F_Tong() {
      ...
      for (let i1 = 0; i1 < this.Data_Food_King.Haisan.length; i1++) {
        this.Data_Food_King.Tong.SL = this.Data_Food_King.Tong.SL + this.Data_Food_King.Haisan[i1].SL;
      }
      this.Data_Food_King.Tong.TT = 0;
      for (let i1 = 0; i1 < this.Data_Food_King.Haisan.length; i1++) {
        this.Data_Food_King.Tong.TT = this.Data_Food_King.Tong.TT + this.Data_Food_King.Haisan[i1].SL * this.Data_Food_King.Haisan[i1].Gia;
      }
      this.Data_Food_King.Tong.DG = 0;
      for (let i1 = 0; i1 < this.Data_Food_King.Haisan.length; i1++) {
        this.Data_Food_King.Tong.DG = this.Data_Food_King.Tong.DG + this.Data_Food_King.Haisan[i1].DG;
      }

      for (let i1 = 0; i1 < this.Data_Food_King.Thuysan.length; i1++) {
        this.Data_Food_King.Tong.SL = this.Data_Food_King.Tong.SL + this.Data_Food_King.Thuysan[i1].SL;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Thuysan.length; i1++) {
        this.Data_Food_King.Tong.TT = this.Data_Food_King.Tong.TT + this.Data_Food_King.Thuysan[i1].SL * this.Data_Food_King.Thuysan[i1].Gia;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Thuysan.length; i1++) {
        this.Data_Food_King.Tong.DG = this.Data_Food_King.Tong.DG + this.Data_Food_King.Thuysan[i1].DG;
      }

      for (let i1 = 0; i1 < this.Data_Food_King.Cacloaithit.length; i1++) {
        this.Data_Food_King.Tong.SL = this.Data_Food_King.Tong.SL + this.Data_Food_King.Cacloaithit[i1].SL;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Cacloaithit.length; i1++) {
        this.Data_Food_King.Tong.TT = this.Data_Food_King.Tong.TT + this.Data_Food_King.Cacloaithit[i1].SL * this.Data_Food_King.Cacloaithit[i1].Gia;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Cacloaithit.length; i1++) {
        this.Data_Food_King.Tong.DG = this.Data_Food_King.Tong.DG + this.Data_Food_King.Cacloaithit[i1].DG;
      }

      for (let i1 = 0; i1 < this.Data_Food_King.Khac.length; i1++) {
        this.Data_Food_King.Tong.SL = this.Data_Food_King.Tong.SL + this.Data_Food_King.Khac[i1].SL;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Khac.length; i1++) {
        this.Data_Food_King.Tong.TT = this.Data_Food_King.Tong.TT + this.Data_Food_King.Khac[i1].SL * this.Data_Food_King.Khac[i1].Gia;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Khac.length; i1++) {
        this.Data_Food_King.Tong.DG = this.Data_Food_King.Tong.DG + this.Data_Food_King.Khac[i1].DG;
      }

      for (let i1 = 0; i1 < this.Data_Food_King.Douong.length; i1++) {
        this.Data_Food_King.Tong.SL = this.Data_Food_King.Tong.SL + this.Data_Food_King.Douong[i1].SL;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Douong.length; i1++) {
        this.Data_Food_King.Tong.TT = this.Data_Food_King.Tong.TT + this.Data_Food_King.Douong[i1].SL * this.Data_Food_King.Douong[i1].Gia;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Douong.length; i1++) {
        this.Data_Food_King.Tong.DG = this.Data_Food_King.Tong.DG + this.Data_Food_King.Douong[i1].DG;
      }

      for (let i1 = 0; i1 < this.Data_Food_King.Trangmieng.length; i1++) {
        this.Data_Food_King.Tong.SL = this.Data_Food_King.Tong.SL + this.Data_Food_King.Trangmieng[i1].SL;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Trangmieng.length; i1++) {
        this.Data_Food_King.Tong.TT = this.Data_Food_King.Tong.TT + this.Data_Food_King.Trangmieng[i1].SL * this.Data_Food_King.Trangmieng[i1].Gia;
      }
      for (let i1 = 0; i1 < this.Data_Food_King.Trangmieng.length; i1++) {
        this.Data_Food_King.Tong.DG = this.Data_Food_King.Tong.DG + this.Data_Food_King.Trangmieng[i1].DG;
      }
    },
    // F_Open_Dark() {
    //   if (this.Dark == true) {
