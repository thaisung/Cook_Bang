<template>
    <div class="flex min-h-screen min-w-screen bg-slate-600  " >
        ...
        <div class="flex lg:hidden fixed z-50 w-screen h-[50px] bg-slate-900 text-slate-100 bottom-0 text-[25px] justify-center items-center cursor-pointer">
          <font-awesome-icon icon="fa-solid fa-list-ul" class="w-1/2" v-on:click="counter.Menu=!counter.Menu; counter.HD=false;"/>
          <font-awesome-icon icon="fa-solid fa-file-lines" class="w-1/2 border-l-[2px] border-slate-100" v-on:click="counter.HD=!counter.HD; counter.Menu=false;"/>
        </div>
    </div>
